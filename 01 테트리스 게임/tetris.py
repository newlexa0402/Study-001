...
class TetrisApp(object):
    ...
    def center_msg(self, msg):
        x, y = (self.width - self.default_font.size(msg)[0]) // 2, self.height // 2
        self.screen.blit(self.default_font.render(msg, True, (255, 255, 255)), (x, y))
    ...
    def add_cl_lines(self, n):
        ...
        if self.lines >= self.level * 6:
            self.level += 1
            self.fall_speed -= self.speed_increase_per_level
